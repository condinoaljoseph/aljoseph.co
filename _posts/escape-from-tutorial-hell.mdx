...
<figure className="mb-7">
	<Image
		src="/assets/blog/escape-from-tutorial-hell/cover.jpg"
		alt="the man who can't be moved"
		layout="responsive"
		width={1240}
		height={620}
	/>
...
2. **Contribute to open source.** Find a project that interest you, solve a problem or add a new feature. It is a great feeling when your pull request is approved.

3. **Join a community.** You will get exposed to new ideas, best practices, and practical suggestions and learn a lot from members of the community. Communities provide you the most efficient way to share, ask, and find an answer.
