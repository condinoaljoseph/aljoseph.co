...
Let's try to Implement this concept on the text formatting application.
...
With the strategy pattern implemented, users can easily switch between formatting methods.
...
If you want to learn more about design patterns, especially in TypeScript, feel free to subscribe to my newsletter or visit my repository on [design patterns in typescript](https://github.com/condinoaljoseph/design-patterns-typescript/).