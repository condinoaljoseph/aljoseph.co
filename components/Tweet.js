...
export default function Tweet({
	...
	return (
		<div className="bg-gray-50 dark:bg-gray-800 flex items-center justify-center mb-7">
			<div className="bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800 rounded-lg border -mx-4 p-4">
				<div className="flex justify-between">
					...
					<svg
						className="text-pink-500 dark:text-pink-300 h-6 w-auto inline-block fill-current"
						viewBox="0 0 24 24"
					>
						<g>
				...
				>
					<div className="flex items-center mr-4 text-pink-700 dark:text-pink-300">
						<svg className="fill-current h-5 w-auto" viewBox="0 0 24 24">
							<g>
